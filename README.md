...
<div align="center">
  <img src="ide_main.svg" alt="Zyntax Studio Main Interface" width="800" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.5);" />
  ...
  <table border="0">
    <tr>
      <td width="50%" align="center">
        <img src="ide_terminal.svg" alt="Integrated Terminal" style="border-radius: 5px;" />
        <br/><strong>Integrated Zyntax Terminal</strong>
      </td>
      <td width="50%" align="center">
        <img src="ide_git.svg" alt="Git Control" style="border-radius: 5px;" />
        <br/><strong>Built-in Source Control</strong>
      </td>
    </tr>
    <tr>
      <td width="50%" align="center">
        <img src="ide_ai_chat.svg" alt="AI Agent" style="border-radius: 5px;" />
        <br/><strong>ZynAssistant AI</strong>
      </td>
      <td width="50%" align="center">
        <img src="ide_debug.svg" alt="Debugging" style="border-radius: 5px;" />
        <br/><strong>Advanced Debugging</strong>
      </td>
    </tr>
  </table>
</div>
